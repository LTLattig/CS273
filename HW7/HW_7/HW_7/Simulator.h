...
public:
	...
	void show_stats()
	{
		...
		std::cout << "Average wait time for landing queue: " << landing_queue->get_total_wait() / landing_queue->get_num_served() << std::endl;
		...
		std::cout << "Average wait time for landing queue: " << departure_queue->get_total_wait() / departure_queue->get_num_served() << std::endl;
